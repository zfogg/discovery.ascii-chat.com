...
This repository hosts the static website for ACDS public key distribution. The website serves Ed25519 public keys over HTTPS, which clients use to verify the identity of the official ACDS server at `discovery-server.ascii-chat.com:27225`.
...
**Trust chain:**
```
HTTPS CA → discovery.ascii-chat.com → ACDS public key → discovery-server.ascii-chat.com:27225
```
...
- **ACDS server** - Runs at `discovery-server.ascii-chat.com:27225` (not open source)
